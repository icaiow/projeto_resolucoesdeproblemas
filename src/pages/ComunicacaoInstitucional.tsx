...
const ComunicacaoInstitucional = () => {
  ...
  const mensagens = [
    ...
    {
      id: 2,
      remetente: "João Santos",
      assunto: "Ausência do aluno",
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Painel de Comunicação</h1>
        </div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Envie uma mensagem para responsáveis
                </p>
              </div>
            </div>
...
export default ComunicacaoInstitucional; 